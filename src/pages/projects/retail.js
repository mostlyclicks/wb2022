...
const index = ({data}) => {
  ...
  return (
    <Layout>
      <SEO
        title="Projects: Retail"
        description="See Wieser Brothers Retail projects. Contact us at 507.895.8903 for more information."
      />
      <ProjectWrapper>
        <L2MainImage>
          <L2Title>
...
export const ProjectQuery = graphql`
  query {
    allPrismicProject(filter: { tags: { eq: "retail" } }) {
      totalCount
      edges {
        node {
          uid
