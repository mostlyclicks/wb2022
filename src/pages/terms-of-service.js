    ...
    <Layout>
      ...
      <Content>
        ...
        <p>
          ...
          <a href="https://wieserbrothers.com/">https://wieserbrothers.com/</a>{" "}
          and any related services provided by Wieser Brothers General
          Contractor, Inc..{" "}
        </p>
        <p>
          By accessing{" "}
          ...
          using any other services provided by Wieser Brothers General
          Contractor, Inc..{" "}
        </p>
        <p>
          We, Wieser Brothers General Contractor, Inc., reserve the right to
          review and amend any of these Terms of Service at our sole discretion.
          Upon doing so, we will update this page. Any changes to these Terms of
          Service will take effect immediately from the date of publication.{" "}
        </p>
        <p>These Terms of Service were last updated on 7 April 2021. </p>
        ...
        <ol>
          ...
          <li>
            ...
            service Wieser Brothers General Contractor, Inc. provides;
          </li>
          <li>
        ...
        <p>
          ...
          are owned by or licensed to Wieser Brothers General Contractor, Inc.
          and are protected by applicable copyright and trademark law. We grant
        ...
        <p>
          ...
          restrictions or the Terms of Service, and may be terminated by Wieser
          Brothers General Contractor, Inc. at any time.{" "}
        </p>
        <h3>Liability</h3>
        <p>
          Our website and the materials on our website are provided on an 'as
          is' basis. To the extent permitted by law, Wieser Brothers General
          Contractor, Inc. makes no warranties, expressed or implied, and hereby
        ...
        <p>
          In no event shall Wieser Brothers General Contractor, Inc. or its
          suppliers be liable for any consequential loss suffered or incurred by
          you or any third party arising from the use or inability to use this
          website or the materials on this website, even if Wieser Brothers
          General Contractor, Inc. or an authorized representative has been
        ...
        <p>
          ...
          for general information purposes only. Wieser Brothers General
          Contractor, Inc. does not warrant or make any representations
          concerning the accuracy, likely results, or reliability of the use of
          the materials on this website, or otherwise relating to such materials
          or on any resources linked to this website.{" "}
        </p>
        <h3>Links</h3>
        <p>
          Wieser Brothers General Contractor, Inc. has not reviewed all of the
          ...
          endorsement, approval, or control by Wieser Brothers General
          Contractor, Inc. of the site. Use of any such linked site is at your
        ...
        <p>
          ...
          with the laws of Minnesota. You irrevocably submit to the exclusive
